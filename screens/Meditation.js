...
const Meditation = () => {
  ...
  return (
    <View style={styles.androidLarge13}>
      ...
      />
      <View style={[styles.androidLarge13Item, styles.xboxMenuIconPosition]} />
      <Image
      ...
      /> */}
      <TouchableOpacity onPress={()=>{navigation.navigate(EngageMeditation)}}><Image
        style={styles.backArrowIcon}
        contentFit="cover"
        source={require("../assets/back-arrow.png")}
      /></TouchableOpacity>
       <TouchableOpacity onPress={()=>{navigation.navigate(MeditationVoice)}}>
       <Image
      ...
      />
       ...
       <TouchableOpacity onPress={()=>{navigation.navigate(MeditationMusic)}}>
       <Image
